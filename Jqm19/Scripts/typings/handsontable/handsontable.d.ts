...
interface Handsontable {
    ...
    // Add
    container(): any;
    scrollViewportTo(row: number, col: number, snapToBottom?: boolean, snapToRight?: boolean): boolean;
    getSourceDataArray(row?: number, col?: number, row2?: number, col2?: number): any[];
    view: any;
}
...
interface HandsontableStatic {
    new (element: Element, options: Handsontable.Options): Handsontable;
    editors: any;
}
